...
{	
		...
		public static void main(String[] args) throws Exception
		{
			...
			xlRead("D:\\Selenium Jars\\Google.xls");
			for(int i=1;i<xlRows;i++)
			{
				if(xData[i][1].equalsIgnoreCase("Y"))
				{
					...
					else
					{
						...
						Files.copy(scrFile,new File("D:\\Selenium Jars\\pic"+i+".jpg"));
						xData[i][5]=("D:\\Selenium Jars"+i+".jpg");
						xlwrite("D:\\FinalGoogle.xls",xData);
			...
			xlwrite("D:\\Selenium Jars\\FinalGoogle.xls",xData);
		}
